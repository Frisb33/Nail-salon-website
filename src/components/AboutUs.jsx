  ...
  return (
    <div id="aboutus" className="text-center max-w-3xl mx-auto px-4 mt-10 mb-10"> 
          ...
          <p className="italic text-sm md:text-base leading-relaxed font-comic">
            ''Welcome to <b>Wasaga Nails</b>, your destination for nail care and beauty!
            <br />
            <br />
            At <b>Wasaga Nails</b>, we believe that your hands and feet deserve the utmost care and attention. Our salon is a haven of tranquility where you can escape the hustle and bustle of everyday life and indulge in a pampering experience that leaves you feeling rejuvenated and glamorous.
            <br />
            <br />
